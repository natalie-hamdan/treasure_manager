...
//to do next : integrate the functions in main, start the fork stuff
//later try to make a shared file of the functions so u can just have the main here 

//creating functions for each task being done so i can use fork more easily 
